...
export const UpdateFamilySchema = z.object({
  ...
  parentsLivingSituation:        z.enum(['YES_COMMITTED', 'OPEN', 'NO_OBJECTION', 'PREFER_SEPARATE']).optional(),
  familyDecisionInvolvement:     z.enum(['HIGH_COLLABORATIVE', 'CONSULTATIVE', 'INFORMED_ONLY', 'INDEPENDENT']).optional(),
  culturalEventsAttendance:      z.enum(['ALWAYS', 'IMPORTANT_ONLY', 'OCCASIONALLY', 'RARELY']).optional(),
  religiousObservanceWithFamily: z.enum(['VERY_ACTIVE_TOGETHER', 'ACTIVE_INDIVIDUALLY', 'OCCASIONAL', 'PERSONAL_ONLY', 'NOT_PRACTICING']).optional(),
