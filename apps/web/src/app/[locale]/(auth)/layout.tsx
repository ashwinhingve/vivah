  ...
  return (
    <div className="relative min-h-screen bg-background flex flex-col items-center justify-center px-4 overflow-hidden">
      ...
      <svg
        ...
        fill="none"
      >
        <circle cx="200" cy="200" r="190" stroke="var(--color-gold)" strokeWidth="1.5" />
        <circle cx="200" cy="200" r="155" stroke="var(--color-gold)" strokeWidth="1" />
        <circle cx="200" cy="200" r="120" stroke="var(--color-gold)" strokeWidth="1.5" />
        <circle cx="200" cy="200" r="85" stroke="var(--color-gold)" strokeWidth="1" />
        <circle cx="200" cy="200" r="50" stroke="var(--color-gold)" strokeWidth="1.5" />
        {[0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330].map((deg) => {
          ...
          return <line key={deg} x1={x1} y1={y1} x2={x2} y2={y2} stroke="var(--color-gold)" strokeWidth="0.75" />;
        })}
        {[0, 45, 90, 135, 180, 225, 270, 315].map((deg) => {
          const r = (deg * Math.PI) / 180;
          const cx = 200 + 120 * Math.cos(r);
          const cy = 200 + 120 * Math.sin(r);
          return <circle key={deg} cx={cx} cy={cy} r="6" stroke="var(--color-gold)" strokeWidth="1" />;
        })}
      </svg>
      ...
      <svg
        ...
        fill="none"
      >
        <circle cx="100" cy="100" r="95" stroke="var(--color-primary)" strokeWidth="1.5" />
        <circle cx="100" cy="100" r="65" stroke="var(--color-primary)" strokeWidth="1" />
        <circle cx="100" cy="100" r="35" stroke="var(--color-primary)" strokeWidth="1.5" />
        {[0, 45, 90, 135, 180, 225, 270, 315].map((deg) => {
          const r = (deg * Math.PI) / 180;
          ...
          return <line key={deg} x1={x1} y1={y1} x2={x2} y2={y2} stroke="var(--color-primary)" strokeWidth="0.75" />;
        })}
      </svg>
