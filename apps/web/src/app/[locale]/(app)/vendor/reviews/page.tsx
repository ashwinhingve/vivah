      ...
      <main id="main-content" className="mx-auto max-w-3xl px-4 py-8">
          ...
          <PageHeader
            ...
            subtitle={
              avg
                ...
                : 'Replies to reviews build trust with future couples.'
            }
          />
        </FadeUp>
        ...
        {reviews.length === 0 ? (
          ...
          <StaggerList className="space-y-3">
            {reviews.map((r) => (
              <div key={r.id} className="rounded-xl border border-gold/20 bg-surface p-4 shadow-card sm:p-6">
                ...
                {r.vendorReply ? (
                  <div className="mt-3 rounded-lg border-l-2 border-teal/40 bg-teal/5 px-3 py-2">
                    <p className="text-xs font-medium text-teal">Your reply</p>
