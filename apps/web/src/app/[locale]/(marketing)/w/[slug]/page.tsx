        ...
        <section className="max-w-3xl mx-auto px-6 py-12">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {view.ceremonies.map((c, i) => (
              <div key={i} className="bg-surface border border-gold/20 rounded-2xl p-5">
      ...
      {view.registryEnabled && view.registry.length > 0 && (
        <section className="max-w-3xl mx-auto px-6 py-12">
          ...
          <div className="space-y-3">
            {view.registry.map(r => (
              <div key={r.id} className="bg-surface border border-gold/20 rounded-2xl p-4 flex items-center gap-4">
                {r.imageUrl && (
