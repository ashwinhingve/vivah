  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-xl border border-[#E8E0D8] shadow-sm overflow-hidden">
        <div className="bg-gradient-to-r from-[#7B2D42]/5 to-[#0E7C7B]/5 px-6 pt-8 pb-6 text-center">
          <div className="w-16 h-16 rounded-full bg-[#E8E0D8] flex items-center justify-center mx-auto mb-4">
        ...
        <div className="px-6 py-5 space-y-3">
          {/* Benefits */}
          <p className="text-xs font-semibold uppercase tracking-widest text-[#9E7F5A]" aria-hidden="true">
            What you unlock
          </p>
          {[
            ...
            <div key={text} className="flex items-center gap-3">
              ...
              <span className="text-sm text-[#2E2E38]">{text}</span>
            </div>
          ))}
        </div>
      ...
      {/* Privacy note */}
      <div className="rounded-xl border border-[#C5A47E]/30 bg-[#C5A47E]/5 px-5 py-4 flex items-start gap-3">
        ...
        <p className="text-xs text-[#6B6B76] leading-relaxed">
          Your Aadhaar number is <strong className="text-[#2E2E38]">never stored</strong> on our servers.
          We only receive a verification status from DigiLocker. Your data stays with the Government of India.
        </p>
      </div>

      {/* How it works */}
      <div className="bg-white rounded-xl border border-[#E8E0D8] shadow-sm p-5">
        <h3 className="text-sm font-semibold text-[#2E2E38] mb-4">How it works</h3>
        <ol className="space-y-4">
          {[
            ...
            <li key={step} className="flex items-start gap-3">
              <span className="w-7 h-7 rounded-full bg-[#0E7C7B]/10 text-[#0E7C7B] text-xs font-bold flex items-center justify-center shrink-0 mt-0.5">
                {step}
              </span>
              <div>
                <p className="text-sm font-medium text-[#2E2E38]">{title}</p>
      ...
      <div className="text-center">
        <Link href="/dashboard" className="text-sm text-[#6B6B76] hover:text-[#2E2E38]">
          Skip for now
        </Link>
      </div>
    </div>
...
function InReviewState() {
  return (
    <div className="space-y-5">
      <div className="bg-white rounded-xl border border-[#E8E0D8] shadow-sm overflow-hidden">
        <div className="bg-gradient-to-r from-[#D97706]/5 to-transparent px-6 pt-8 pb-6 text-center">
          <div className="w-16 h-16 rounded-full bg-[#D97706]/10 flex items-center justify-center mx-auto mb-4 relative">
              ...
              <div key={label} className="flex items-start gap-3">
                <div className="flex flex-col items-center">
                  <div className={`w-7 h-7 rounded-full flex items-center justify-center shrink-0 text-xs font-bold border-2 ${
                      ...
                      : 'bg-white border-[#E8E0D8] text-[#6B6B76]'
                  }`}>
                    {done ? (
                      ...
                      <span className="w-2 h-2 rounded-full bg-[#D97706] animate-pulse" aria-label="In progress" />
                    ) : (
                      <span>{i + 1}</span>
                    )}
                  </div>
                  {i < 3 && (
                    <div className={`w-0.5 h-6 ${done ? 'bg-[#059669]' : 'bg-[#E8E0D8]'}`} aria-hidden="true" />
                  )}
                </div>
                <p className={`text-sm pt-1 pb-5 ${done ? 'text-[#059669] font-medium' : active ? 'text-[#D97706] font-semibold' : 'text-[#6B6B76]'}`}>
                  {label}
                </p>
              </div>
            ))}
      ...
      <div className="rounded-xl border border-[#E8E0D8] bg-white p-4 flex items-center gap-3">
      ...
      <div className="text-center">
        <Link href="/dashboard" className="text-sm text-[#0E7C7B] font-medium hover:text-[#149998]">
          Return to Dashboard →
        </Link>
      </div>
    </div>
...
function VerifiedState({ verifiedAt }: { verifiedAt?: string }) {
  ...
  return (
    <div className="space-y-5">
      <div className="bg-white rounded-xl border border-[#059669]/20 shadow-sm overflow-hidden">
        <div className="bg-gradient-to-r from-[#059669]/5 to-transparent px-6 pt-8 pb-6 text-center">
        ...
        <div className="px-6 py-5 space-y-4">
          {/* Badge earned */}
          <div className="rounded-xl border border-[#059669]/20 bg-[#059669]/5 p-4 flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-[#059669]/10 flex items-center justify-center shrink-0">
            ...
            <div>
              <p className="text-sm font-semibold text-[#059669]">ID Verified Badge</p>
              <p className="text-xs text-[#6B6B76] mt-0.5">Now visible on your profile to all families</p>
            </div>
          </div>

          {/* What's unlocked */}
          <div className="space-y-2.5">
            <p className="text-xs font-semibold text-[#6B6B76]">Unlocked for you</p>
            {[
        ...
        <div className="px-6 pb-6">
          <Link
            href="/dashboard"
            className="w-full inline-flex items-center justify-center bg-[#0E7C7B] hover:bg-[#149998] text-white font-semibold rounded-lg px-6 py-3 min-h-[48px] transition-colors"
          >
            View Your Matches →
          </Link>
        </div>
...
function RejectedState({ note }: { note?: string }) {
  return (
    <div className="space-y-5">
      <div className="bg-white rounded-xl border border-[#DC2626]/20 shadow-sm overflow-hidden">
        <div className="bg-gradient-to-r from-[#DC2626]/5 to-transparent px-6 pt-8 pb-6 text-center">
        ...
        {note && (
          <div className="mx-6 mb-2 rounded-lg border border-[#DC2626]/20 bg-[#DC2626]/5 px-4 py-3">
            <p className="text-xs font-semibold text-[#DC2626] mb-1">Reason from our team</p>
            <p className="text-sm text-[#2E2E38]">{note}</p>
          </div>
        )}

        <div className="px-6 py-5 space-y-3">
          <p className="text-sm font-medium text-[#2E2E38]">Common reasons for rejection</p>
          {[
            ...
            <div key={reason} className="flex items-start gap-2.5">
              <span className="text-[#DC2626] mt-0.5 text-xs shrink-0">•</span>
              <span className="text-sm text-[#6B6B76]">{reason}</span>
            </div>
          ))}
        </div>
        ...
        <div className="px-6 pb-6 space-y-3">
          ...
          <p className="text-center text-xs text-[#6B6B76]">
            Need help?{' '}
            <Link href="/support" className="text-[#0E7C7B] underline-offset-2 hover:underline">
              Contact support
            </Link>
          </p>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#FEFAF6]">
      <div className="mx-auto max-w-lg px-4 py-8">
        ...
        <Link
          href="/dashboard"
          className="inline-flex items-center gap-1.5 text-sm text-[#6B6B76] hover:text-[#2E2E38] mb-6 transition-colors"
        >
