...
// Same mandap + diya motif as icon.svg, minus the background (the div paints it).
const MARK = `<svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 32 32">
  ...
  <path d="M16 9.4 C 19.6 12.8, 18.7 16.4, 16 18.4 C 13.3 16.4, 12.4 12.8, 16 9.4 Z" fill="#E9C9A0"/>
